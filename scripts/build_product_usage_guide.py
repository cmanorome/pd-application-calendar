...
def catalog() -> tuple[list[dict], list[dict]]:
    ...
    add(
        ...
        frequency_text="Apply every 4 weeks during active growth. Vegetables can be applied fortnightly when actively producing. Trees, fruit and vines can be applied every 6–8 weeks as required.",
        cadence_days=28,
        cadence_min_days=14,
        cadence_max_days=56,
        window="growing_season",
    ...
    add(
        ...
        method="spread",
        water_in=1,
        application_notes="Apply evenly by hand or broadcast spreader, then water in to activate. Suitable for lawns, vegetables, fruit trees, crops, ornamentals and all soil types. Can be applied alongside fertilisers, side dressing, seeding and planting.",
    ...
    add(
        ...
        fertigation=1,
        jar_test=1,
        application_notes="Shake well before use and maintain constant agitation. Can be applied through fertigation, watering cans or spray equipment. A coarse filter is recommended, and a jar test should be performed before mixing. Not suitable for drippers.",
        ...
        rates=[
            {"use_case": "home_garden", "method": "drench", "amount_text": "45 mL per 9 L water", "notes": "Apply at 1 L/m²"},
            {"use_case": "soil_amelioration_fertigation", "method": "fertigation", "amount_text": "10–50 L/ha"},
            {"use_case": "foliar", "method": "foliar", "amount_text": "1 L per 100 L water", "notes": "Rate varies by crop"},
        ],
    )
    add(
        "NSWL",
